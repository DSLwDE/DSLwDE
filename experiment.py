...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--portfolio', default = 'maxsortino', choices = ['maxsortino', 'onehot'])
    ...
    yearmons, data, torch_data, torch_target_data, missing_mask = preprocess_data(f'data/{args.universe}.csv', device)
    ...
    common_path = f'result/{args.universe}_{args.portfolio}_{args.model}_{args.optimizer}'
